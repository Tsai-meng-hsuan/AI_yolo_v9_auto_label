        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    detection_list.append([*xyxy, conf, cls])
...
def parse_opt(weight_path, image_path):
    ...
    parser.add_argument('--name', default='output_image', help='save results to project/name')
